...
from networks import CNN_v1, CNN_v2, MLP
...
def main():
    ...
    parser.add_argument('--train_val_split',type=float,default=0.9,help="Set Train and Validation data split.(Optional)")
    # Parse the arguments
    ...
    if args.train:
        ...
        if args.evaluate:  # If we want to evaluate after training
            ...
            trainer.test(lightning_model, test_loader)  # Test on validation set
